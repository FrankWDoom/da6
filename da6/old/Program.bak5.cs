...
");
        ...
        public static void Run(Inputs inputs)
        {
            ...
            var slice = prgSlices.Last(); // todo appropriate slice for vectors


            nmi = wordStr(slice, slice.Length - 6);
            reset = wordStr(slice, slice.Length - 4);
            brk = wordStr(slice, slice.Length - 2);
            ...
            while (pass <= lastPass)
            {
                ...
                while (index < slice.Length && counter < fileLength)
                {
                    ...
                    if (counter >= 0xe1e7 && counter < (0xe1e7 + 3))
                    {
